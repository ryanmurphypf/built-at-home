...
export default function Dashboard({ workouts }: { workouts: Workout[] }) {
      ...
      <div className="mb-8 p-4 rounded-xl text-sm" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
        ...
        <div className="flex flex-col gap-2">
          ...
          <StructureRow label="1) Upper Superset" detail="3 rounds" accent>
            <StructureSubRow label="A) Pull" detail="Rest 1:30–2:00" />
            <StructureSubRow label="B) Push" detail="Rest 1:30–2:00" />
          </StructureRow>
          <StructureRow label="2) Lower" detail="3 rounds" accent>
            <StructureSubRow label="C) Squat / Hinge / Plyo" detail="Rest 1:30–2:00" />
          </StructureRow>
          <StructureRow label="3) Core" detail="0–3 rounds · optional" accent>
            <StructureSubRow label="D) Static / Dynamic" detail="Rest as needed" />
          </StructureRow>
